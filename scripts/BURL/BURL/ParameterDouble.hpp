...
class ParameterDouble : public Parameter {
    ...
    public:
                                    ...
                                    ParameterDouble(double prob, std::string n, MultivariateNormalPhylogeneticModel* m); //no bounds
                                    ParameterDouble(double prob, std::string n, MultivariateNormalPhylogeneticModel* m, double min); //min bound
                                    ParameterDouble(double prob, std::string n, double min); //min bound
                                    ParameterDouble(double prob, std::string n); //no bounds
